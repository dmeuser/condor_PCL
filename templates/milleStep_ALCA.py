...
# with command line options: milleStep -s ALCA:PromptCalibProdSiPixelAli --conditions 124X_dataRun3_Express_v5 --datatier ALCARECO --eventcontent ALCARECO --triggerResultsProcess RECO --customise_commands process.MessageLogger.cerr.FwkReport.reportEvery = 1000 --processName=ReALCA -n -1 --no_exec
...
process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(
        ...
        connect = cms.string('sqlite_file:/eos/cms/store/caf/user/dmeuser/PCL/condor_PCL_2022/output/payloads.db')),
    cms.PSet(
